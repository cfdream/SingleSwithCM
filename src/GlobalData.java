...
public class GlobalData {
	...
	//public static String RESULT_FILE_NAME = "data\\intervalResultsDiffLossRatioMethod1.txt";
	...
	public static int OBJECT_VOLUME_OR_RATE = 2;		//1:volume > threshold, 2: loss rate > threshold
	//METHOD_NUMBER=0->overwrite when collision happens; =1->replace mechanism
	public static int METHOD_NUMBER = 0;				//valid only when OBJECT_VOLUME_OR_RATE=2
	...
	//public static double DEAFULT_BYTE_SAMPLE_RATE = 2.2e-6;		//loss volume v1 prob
	//public static double DEAFULT_BYTE_SAMPLE_RATE = 4e-5;			//loss volume v2 prob
	//public static double DEAFULT_BYTE_SAMPLE_RATE = 2e-3; 		//loss rate replace(method1) prob
	...
	/*
	//sample and hold: default increase of sample rate per bit, when meeting one loss packet
	public static double DEFAULT_DELTA_BYTE_SAMPLE_RATE = 1.7e-6;
	//DEFAULT_DELTA_BYTE_SAMPLE_RATE : start value
	public static double DEFAULT_DELTA_BYTE_SAMPLE_RATE_START = 2.2e-10;
	//DEFAULT_DELTA_BYTE_SAMPLE_RATE : end value
	public static double DEFAULT_DELTA_BYTE_SAMPLE_RATE_END = 2.2e-1;
	//DEFAULT_DELTA_BYTE_SAMPLE_RATE : increase times
	public static int DEFAULT_DELTA_BYTE_SAMPLE_RATE_INCREASE_TIMES = 10;
	*/
